                ...
                <div class="col-3">
                    <div class="card" style="width: 27rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?php echo e(url('/todo/'.$todo->id.'/edit')); ?>" class="btn btn-outline-success" style="float: right;"> Edit </a>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\workspace\resources\views/user/userMywork.blade.php ENDPATH**/ ?>