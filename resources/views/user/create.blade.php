            ...
            <div class="col-md-8">
                <form method="post" action="{{url('/todo')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Title ..." name="title" value="{{old('title')}}">
                    </div>
...
{{--                    </div>--}}
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="About ..." name="about" value="{{old('about')}}">
                    </div>
