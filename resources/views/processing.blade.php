        ...
        <div class="d-flex">
            ...
            <div class="p-2">
                <span>
                    ...
                    <a href="{{route('processRepair')}}" style="font-size: 20px; padding-top:10px; color: black;">กำลังดำเนินการ </a>|
            ...
            @foreach($repairs as $repair)
                <tr>
                    ...
                    <td style="text-align: center;">
                        ...
                        <button id="myBtn2" class="btn btn-success" type="submit">ส่งแจ้งเตือน</button>
                    ...
                    <td style="text-align: center;">
                        ...
                        <a href="{{route('acceptRepair2', $repair->id)}}" id="myBtn2" class="btn btn-outline-success">ดำเนินการแล้ว</a>
