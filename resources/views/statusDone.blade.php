...
@section('content')
    ...
    <form action="/repair" method="GET">
        ...
        <div class="d-flex">
            ...
            <div class="p-2">
                <span>
                    <a class="active-menu" href="/repair" style="font-size: 20px; padding-top:10px; color: grey;">รายการทั้งหมด </a>|
            ...
            @foreach($repairs as $repair)
                <tr>
                    ...
                    <td style="text-align: center;">
                        ...
                        <button id="myBtn2" class="btn btn-outline-success" onclick="reply('{{$repair->roomid}}' ,'ห้อง {{$repair->roomid}} ซ่อมเสร็จแล้วจ้า')" type="submit">แจ้งเตือน</button>
                    ...
                    <td style="text-align: center;">
                        ...
                        <a href="{{route('acceptRepair2', $repair->id)}}" id="myBtn2" class="btn btn-outline-warning">ดำเนินการแล้ว</a>
                    ...
                    <td style="text-align: center;">
                        ...
                        <a href="{{route('acceptRepair', $repair->id)}}" id="myBtn2" class="btn btn-outline-danger">รับเรื่องซ่อม</a>
                    </td>
                    @endif
