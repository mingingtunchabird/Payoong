    ...
    <div class="container">
        <div class="d-flex">
            ...
            <div class="d-flex">
                ...
                <div class="p-2">
                    <span>
                        <a class="active-menu" href="/package" style="font-size: 20px; padding-top:10px; color: grey;">รายการทั้งหมด </a>|
                        <a href="{{route('packageRecieved')}}" style="font-size: 20px; padding-top:10px; color: black;">รับแล้ว </a>|
            ...
            @foreach($packages as $package)
                <tr>
                    ...
                    <td style="text-align: center;">
                        ...
                        <a href="#" id="myBtn2" class="btn btn-outline-success">รับแล้ว</a>
                    </td>
                    @endif
